...
five equally spaced cells and the second order upwind scheme for convection
...
adv1.setU(u)
adv1.calcCoef('UpW2', PhiA, PhiB) # Se calcula la parte advectiva de los coeficientes 
#
...
coef.bcDirichlet('LEFT_WALL', Phi[0], 'UpW2')   # Se actualizan los coeficientes
coef.bcDirichlet('RIGHT_WALL', Phi[-1], 'UpW2') # de acuerdo a las cond. de frontera
...
plt.grid()
plt.legend()
plt.savefig('Problema5.1-Upwind_2do_Orden.pdf')
plt.show()
